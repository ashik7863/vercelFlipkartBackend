...
//   {
//       id: 'product8',
//       url: 'https://rukminim1.flixcart.com/image/416/416/k51cpe80/printer/n/a/r/hp-mfp-138fnw-original-imafnt84exxxdyfy.jpeg?q=70',
//       detailUrl: 'https://rukminim1.flixcart.com/image/416/416/kcgk1ow0/headphone/n/u/a/235v2-fast-charging-boat-original-imaftk6us4af7bca.jpeg?q=70',
//       title: {
//           shortTitle: 'Printers',
//           longTitle: 'Epson'
...
const AllController=require("./controller/productController");
...
//   res.send(data);
// });
app.get('/product',AllController.getProducts);
app.post('/signup',AllController.registration);
app.post('/login',AllController.login);
app.get('/product/:id',AllController.getProductById);
